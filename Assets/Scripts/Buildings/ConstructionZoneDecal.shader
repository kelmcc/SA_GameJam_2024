...
Shader  "ConstructionZoneDecal"
{
	Properties
    {
        ...
        _Color("Color", Color) = (1,0.7254902,0,1)
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			)
			{
				...
				surfaceDescription.BaseColor = ( _Color.rgb * temp_output_21_0 );
        ...
        Pass
        {
			...
			)
			{
				...
				float3 BaseColor = ( _Color.rgb * temp_output_21_0 );
...
Node;AmplifyShaderEditor.ColorNode;31;192,-160;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,0.7254902,0,1;1,0.7265503,0,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=DDFCE6FFA51212B583A0706E4C80F2CFB66071B2