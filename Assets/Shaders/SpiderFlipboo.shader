	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float temp_output_4_0_g1 = 1.0;
				float temp_output_5_0_g1 = 8.0;
				...
				// Speed of animation
				float fbspeed246_g1 = _TimeParameters.x * 8.0;
				...
				// Flipbook UV
				half2 fbuv246_g1 = texCoord14 * fbtiling246_g1 + fboffset246_g1;
				// *** END Flipbook UV Animation vars ***
				int flipbookFrame246_g1 = ( ( int )fbcurrenttileindex246_g1);
				float4 temp_output_11_53 = tex2D( _Flipbook, fbuv246_g1 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = temp_output_11_53.rgb;
				float Alpha = (temp_output_11_53).a;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = (temp_output_11_53).a;
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.TextureCoordinatesNode;14;-584,-320;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;13;-480,-544;Inherit;True;Property;_Flipbook;Flipbook;0;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;11;-272,-432;Inherit;False;Flipbook;-1;;1;53c2488c220f6564ca6c90721ee16673;3,68,0,217,0,244,0;11;51;SAMPLER2D;0.0;False;167;SAMPLERSTATE;0;False;13;FLOAT2;0,0;False;24;FLOAT;0;False;210;FLOAT;4;False;4;FLOAT;1;False;5;FLOAT;8;False;130;FLOAT;8;False;2;FLOAT;0;False;55;FLOAT;0;False;70;FLOAT;0;False;5;COLOR;53;FLOAT2;0;FLOAT;47;FLOAT;48;INT;218
Node;AmplifyShaderEditor.SwizzleNode;17;114,-343.5;Inherit;False;FLOAT;3;1;2;3;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
...
WireConnection;11;51;13;0
WireConnection;11;13;14;0
WireConnection;17;0;11;53
WireConnection;1;2;11;53
WireConnection;1;3;17;0
ASEEND*/
//CHKSM=FCBC970A21D752337BE8908197263F6FCAE9755E